...
//		Vector3 boundBox = max - min;
	...
	void AddPartsToList(){
		...
		foreach(GameObject g in Resources.LoadAll("HousePrefabs/Apartment1/Corner/Low", typeof(GameObject))){
			corner_LOW.Add(g.transform);
		}
		foreach(GameObject g in Resources.LoadAll("HousePrefabs/Apartment1/Corner/Mid", typeof(GameObject))){
			corner_MID.Add(g.transform);
		}
		foreach(GameObject g in Resources.LoadAll("HousePrefabs/Apartment1/Corner/Top", typeof(GameObject))){
			corner_TOP.Add(g.transform);
		}
		foreach(GameObject g in Resources.LoadAll("HousePrefabs/Apartment1/Center/Low", typeof(GameObject))){
			center_LOW.Add(g.transform);
		}
		foreach(GameObject g in Resources.LoadAll("HousePrefabs/Apartment1/Center/Mid", typeof(GameObject))){
			center_MID.Add(g.transform);
		}
		foreach(GameObject g in Resources.LoadAll("HousePrefabs/Apartment1/Center/Top", typeof(GameObject))){
...
//			Debug.Log("Cur. Pos.:" + currentPosition);
			...
			test1.gameObject.name = "middleBlock";
